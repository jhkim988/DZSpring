...
<form>
	<section>
		...
		<div id="infoInput">
			...
			<br/>
			<label> <input type="text" placeholder="아이디" id="id"
			...
			<br/>
			<label> <select style="width: 30%" id="phonefirst" class='required'
				data-mapping='markphone'>
					...
					<option>018</option>
					<option>019</option>
			</select> - <input style="width: 30%" "type="number" id="phonemid" class="phone required"
				data-mapping='markphone'> - <input style="width: 30%" type="number"
				id="phonelast" class="phone required" data-mapping='markphone'>
				<br/>
				<mark id="markphone">휴대폰 번호를 입력해주세요</mark>
			</label>
			<br/>
			<label> <input style="width: 30%" id="email" type="text" placeholder="이메일"
				class='required' data-mapping='markemail'> @ <input
				style="width: 30%"
				id="emailHost" type="hidden" class='required'
				data-mapping='markemail' /> <select style="width: 30%" id="emailSelect"
		...
		<div id="termCheck">
			...
			<br/>
			<label> <input type="checkbox" class="term required" /> 개인정보
				수집 및 이용 <small>(필수)</small>
			</label>
			<br/>
			<label> <input type="checkbox" class="term optional" /> 개인정보
				제3자(판매자) 제공 <small>(선택)</small>
			</label>
			<br/>
			<label>
			<input type="checkbox" class="term optional" /> 위치정보
				이용약관 <small>(선택)</small>
			</label>
			<br/>
			<label> <input type="checkbox" class="term optional" /> 혜택
				알림 이메일, 문자, 앱, 푸시 수신 <small>(선택)</small>
			</label>
		</div>
	</section>
	<footer>
		<input type="submit" class="button" id="registerButton" value="회원가입">
